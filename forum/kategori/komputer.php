...
$jumlahData = count(query("SELECT * FROM posting WHERE kategori ='Komputer & PC'"));
...
$list = mysqli_query($conn, "SELECT * FROM posting WHERE kategori='Komputer & PC' ORDER BY tanggal_posting DESC LIMIT $awal,$jumlah_data_perhalaman");
