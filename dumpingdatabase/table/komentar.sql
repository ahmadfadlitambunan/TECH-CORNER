...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2021 at 07:04 PM
...
ALTER TABLE `komentar`
  ...
  ADD CONSTRAINT `komentar_ibfk_2` FOREIGN KEY (`thread_id`) REFERENCES `posting` (`id_thread`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
